...
\033[1;93m|     \033[1;93m[🔥] GITHUB       :\033[1;93mNasrat1                            |

\033[1;94m|     \033[1;94m[🔥] TOOL STATUS  :\033[1;94m ACTIVE FREE            |

\033[1;95m|     \033[1;95m[🔥] TOOL VIRSION :\033[1;95m 0.2                              |
...
def free(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write(f'\r[\033[1;97mNASRAT\033[1;97m] %s|\033[1;92mOK:- %s \r'%(loop,len(oks)));sys.stdout.flush()
